...
export default function Dashboard({ onNavigate }) {
  ...
  useEffect(() => {
    const storedUser = localStorage.getItem('sikepo_user');
    if (storedUser) {
      try {
  ...
  return (
    <div className="app-shell">
      <header className="topbar">
        ...
        {profileOpen && (
          <div className="profile-menu">
            ...
            <small style={{ color: '#6B7280', fontSize: '11px', marginBottom: '4px' }}>
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-foot">SIKEPO v0.1</div>
      </aside>

      <main className="main-content">
        <section className="welcome">
          <h1>{activeMenu}</h1>
          <p>Selamat datang, <span>{userName}</span> ({userRole})</p>
        </section>
